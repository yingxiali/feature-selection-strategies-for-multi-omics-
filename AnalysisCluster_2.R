...
save(scenariogrid_1, file="./VarselCompStudy/Additional_file/Results_2/scenariogrid_1.Rda")

#### 5
# Source the functions that are used in performing the calculations 
# on the cluster:

source("./VarselCompStudy/Additional_file/Functions/Functions_AnalysisCluster_2.R")
...
save(Results, file="./VarselCompStudy/Additional_file/Results_2/Results_AnalysisCluster_2.Rda")
